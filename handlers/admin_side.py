...
async def make_changes_command(message: types.Message):
    ...
    await bot.send_message(message.from_user.id , 'Добро пожаловать' , reply_markup = admin_kb.button_case_admin )
...
def register_handlers_admin(dp : Dispatcher):
    ...
    dp.register_message_handler(cancel_handler , sate = '*' , commands = 'Отмена')
